...
##Create Podman Secrets for Certificates
# On each node, create secrets for their own certificates
sudo podman secret create redis_ca /var/lib/containers/redis/certs/ca.crt
sudo podman secret create redis_cert /var/lib/containers/redis/certs/redis-nodeX.crt  # Replace X with node number
sudo podman secret create redis_key /var/lib/containers/redis/certs/redis-nodeX.key   # Replace X with node number

## Create Podman Volumes
sudo podman volume create redis_data
sudo podman volume create redis_config
sudo podman volume create redis_logs
sudo podman volume create sentinel_config
...
Volume=/var/lib/containers/config/redis/redis.conf:/usr/local/etc/redis/redis.conf:Z
Volume=/var/lib/containers/logs/redis:/var/log/redis:Z
Secret=redis_ca,target=/run/secrets/redis_ca
Secret=redis_cert,target=/run/secrets/redis_cert
Secret=redis_key,target=/run/secrets/redis_key
